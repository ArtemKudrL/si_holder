...
int main()
{
    ...
    Vector v1r = q2.rotate(v1);
    Vector v2r = q2.rotate(v2);
    Vector v3r = q2.rotate(v3);

    std::cout << "rotated vectors" << std::endl;
    std::cout << v1r[0] << " " << v1r[1] << " " << v1r[2] << std::endl;  
    std::cout << v2r[0] << " " << v2r[1] << " " << v2r[2] << std::endl;  
    std::cout << v3r[0] << " " << v3r[1] << " " << v3r[2] << std::endl;  
